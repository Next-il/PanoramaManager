...
The panorama files for the TextInput example.

```
panorama/layout/custom_game/text_input.xml
panorama/styles/custom_game/text_input.css
...
python3 ../../../tools/preview.py panorama/layout/custom_game/text_input.xml 5
```
